...
@$pb.GrpcServiceName('easydaq.ecl')
class eclClient extends $grpc.Client {
  ...
  eclClient(super.channel, {super.options, super.interceptors});
  ...
  $grpc.ResponseStream<$0.Reply> getScaler(
    $0.Request request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$getScaler, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.Reply> getScalerRecent(
    $0.RecentRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$getScalerRecent, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.Reply> getScalerDate(
    $0.DateRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$getScalerDate, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.Expression> getConfig(
    $0.Request request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
  ...
  $grpc.ResponseFuture<$0.ParseResponse> setConfig(
    $async.Stream<$0.Expression> request, {
    $grpc.CallOptions? options,
  }) {
...
abstract class eclServiceBase extends $grpc.Service {
  $core.String get $name => 'easydaq.ecl';
  ...
  $async.Stream<$0.Reply> getScaler_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.Request> $request) async* {
  ...
  $async.Stream<$0.Reply> getScalerRecent_Pre($grpc.ServiceCall $call,
      $async.Future<$0.RecentRequest> $request) async* {
    yield* getScalerRecent($call, await $request);
  }

  $async.Stream<$0.Reply> getScalerRecent(
      $grpc.ServiceCall call, $0.RecentRequest request);

  $async.Stream<$0.Reply> getScalerDate_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.DateRequest> $request) async* {
    yield* getScalerDate($call, await $request);
  }

  $async.Stream<$0.Reply> getScalerDate(
      $grpc.ServiceCall call, $0.DateRequest request);

  $async.Stream<$0.Expression> getConfig_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.Request> $request) async* {
    yield* getConfig($call, await $request);
  }

  $async.Stream<$0.Expression> getConfig(
      $grpc.ServiceCall call, $0.Request request);

  $async.Future<$0.ParseResponse> setConfig(
      $grpc.ServiceCall call, $async.Stream<$0.Expression> request);
